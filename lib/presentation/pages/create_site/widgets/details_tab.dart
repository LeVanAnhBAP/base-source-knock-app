...
class _DetailsTabState extends State<DetailsTab> {
  ...
  void initState() {
    ...
    setData(_bloc.state.siteParams);
    super.initState();
  }
  void setData(SiteParams siteParams){
    setState(() {
  ...
  Widget build(BuildContext context) {
    return BlocProvider.value(
        ...
        child: MultiBlocListener(
          listeners: [
            CreateSiteStatusListener(statuses: const [CreateSiteStatus.success], listener:(context, state) {
              setData(state.siteParams);
            },)
          ],
