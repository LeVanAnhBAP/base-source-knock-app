...
class PartnerRepositoryImpl extends PartnerRepository {
  ...
  @override
  Future<List<PartnerResponse>> paginatePartner(
      PaginatePartnerParams request) async {
    var result =
        await _networkDataSource.paginatePartner(request.page, request.perPage);
    return result.data!.data;
  }

  @override
  Future<void> changeFavoritePartnerState(FavoritePartnerParams request) async{
     await _networkDataSource.changeFavoritePartnerState(request);
  }
}
